...
def get_filtered_hotels_info(city_code, checkin=None, checkout=None):
    filters, total_property_count, response_data = search_hotels(city_code, checkin, checkout)
    hotels_info = extract_hotel_info(response_data)
    return filters, total_property_count, hotels_info

# Example usage:
# city_code = "DEL"  # Example city code
# filters, total_property_count, hotels_info = get_filtered_hotels_info(city_code)