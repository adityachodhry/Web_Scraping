...
def get_booking_reviews(hotel_slug):
    ...
    for review in reviews:
        # print(review)
        publish_date = datetime.strptime(review.find('div', class_='c-review-block__right').find('span', class_='c-review-block__date').text.strip().replace('Reviewed:', '').strip(),'%d %B %Y').strftime('%Y-%m-%d')
