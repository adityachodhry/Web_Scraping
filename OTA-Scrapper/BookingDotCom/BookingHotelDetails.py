...
def scrape_booking_ranks(city_name):
    ...
    class BookingRankings:
        ...
        def parse(html_content):
            ...
            next_page = f"{BookingRankings.base_url}?ss={city_name}&ssne={city_name}&checkin={checkin_date_str}&checkout={checkout_date_str}" + f'&offset={BookingRankings.offset_number}/'
        ...
        @staticmethod
        def scrape_data():
            url = f"{BookingRankings.base_url}?ss={city_name}&ssne={city_name}&checkin={checkin_date_str}&checkout={checkout_date_str}"
...
result_ranks = scrape_booking_ranks(city_name)
