...
def get_HEG_rankings(cityName, num_pages=1):
    ranks = []
...
# Example usage
city_name = "Indore"
hotel_rankings = get_HEG_rankings(city_name, num_pages=1)

try:
    with open('hotel_rankings.json', 'w', encoding='utf-8') as f:
        json.dump(hotel_rankings, f, ensure_ascii=False, indent=4)
        
    print("Data has been saved to hotel_rankings.json")
except Exception as e:
